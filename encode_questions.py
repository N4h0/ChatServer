import json
from setfit import SetFitModel #For o kunne teste med en modell treng med setFit
...
with open('Q@AEnglish.txt', 'r', encoding='utf-8') as file:
    for line in file:
        if line.startswith('Q:'):
            if sublistEnglish:
                sporsmolEnglish.append(sublistEnglish)
...
encodedList = encode_questions(sporsmol, model)
encodedListEnglish = encode_questions(sporsmolEnglish, model)
